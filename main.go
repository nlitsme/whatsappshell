...
var dbAddress = flag.String("db-address", "file:whatsapptool.db?_foreign_keys=on", "Database address")
...
func handleCmd(cmd string, args []string) {
	...
	case "pair-phone":
		...
		linkingCode, err := cli.PairPhone(context.Background(), args[0], true, whatsmeow.PairClientChrome, "whatsapptool")
		if err != nil {
			panic(err)
		}
